...
import game.org.openstreetmap.gui.jmapviewer.checkBoxTree.CheckBoxNodePanel;
import game.org.openstreetmap.gui.jmapviewer.checkBoxTree.CheckBoxTree;
import game.org.openstreetmap.gui.jmapviewer.interfaces.MapObject;
...
public class JMapViewerTree extends JPanel{
    ...
    public JMapViewerTree(String name, boolean treeVisible){
        ...
        map = new JMapViewer(new FrontEndPane());
