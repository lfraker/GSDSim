...
import game.org.openstreetmap.gui.jmapviewer.events.JMVCommandEvent;
import game.org.openstreetmap.gui.jmapviewer.events.JMVCommandEvent.COMMAND;
import game.org.openstreetmap.gui.jmapviewer.interfaces.ICoordinate;
import game.org.openstreetmap.gui.jmapviewer.interfaces.JMapViewerEventListener;
import game.org.openstreetmap.gui.jmapviewer.interfaces.MapMarker;
import game.org.openstreetmap.gui.jmapviewer.interfaces.MapPolygon;
import game.org.openstreetmap.gui.jmapviewer.interfaces.MapRectangle;
import game.org.openstreetmap.gui.jmapviewer.interfaces.TileCache;
import game.org.openstreetmap.gui.jmapviewer.interfaces.TileLoader;
import game.org.openstreetmap.gui.jmapviewer.interfaces.TileLoaderListener;
import game.org.openstreetmap.gui.jmapviewer.interfaces.TileSource;
import game.org.openstreetmap.gui.jmapviewer.tilesources.OsmTileSource;
...
public class JMapViewer extends JPanel implements TileLoaderListener {
    ...
    private FrontEndPane parentComp;
...
//    	System.out.println("BEFOREJM : " + lon + " x : y " + lat);

    	int x = OsmMercator.LonToX(lon, zoom);
        int y = OsmMercator.LatToY(lat, zoom);
//    	System.out.println("AFTERJM : " + x + " x : y " + y);
...
//        System.out.println("BEFORE FINAL X : " + x + " BEFORE FINAL Y " + y);
...
//        System.out.println("FINAL X : " + x + " FINAL Y " + y);
    ...
    protected void paintComponent(Graphics g) {
		...
		g2.drawString(toWrite5, xT, 90.0f);
